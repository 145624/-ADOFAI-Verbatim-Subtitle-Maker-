    ...
    if random=="y":
        ...
        if randomease=="y":
            ...
            while True:
                ...
                level.add_event(floor, "MoveDecorations", duration=duration,positionOffset=[-x1,-y1],tag=tag2, rotationOffset=rotationOffset,opacity=100,angleOffset=a,ease=ease,parallaxOffset=[parallaxOffset1,parallaxOffset2])
                d=d+1
                c1=c1+1#字符数增加
                a=a+angleOffset
                c=c+1#字符数增加
